...
function SpMobile() {
  ...
  return (
    ...
    <div className="logo">
      <div className="logoImage footer-logo" ></div>
    </div>
    <div className="errorContent" style={{marginTop:"15px"}}>
    ...
    <div style={{marginTop:"25px"}}>
      ...
      <a href='/projects' className='homePageButton button1'>
        Projects
      </a>

      <a href='/mission' className='homePageButton button2'>
        Mission
      </a>
      </div>
